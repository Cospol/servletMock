...
<body>
	<a href="PrepareInsertAbitanteServlet">Inserisci nuovo</a>
	<table class="center">
		<thead>
			<tr>
				<th>Nome</th>
		...
		<% List<Abitante> listaDaServlet = (List<Abitante>)request.getAttribute("listAbitantiAttributeName");
				...
				<tr>
					...
					<td>
						<a href="VisualizzaDettaglioAbitanteServlet?idDaInviareComeParametro=<%=abitanteItem.getIdAbitante() %>">Dettaglio</a>
